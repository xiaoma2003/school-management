...
<body>
    ...
    <div class="content">
        ...
        <h2>年级管理</h2>
        <a href="/school/grade/add" class="btn">添加年级</a>
        <table>
            <tr>
                <th>年级名称</th>
                <th>排序</th>
            ...
            <tr>
                ...
                <td>
                    <a href="/school/grade/edit/${grade.gradeId}" class="btn btn-edit" style="display: inline-block;">编辑</a>
                    <a href="/school/grade/delete/${grade.gradeId}" class="btn btn-danger" style="display: inline-block;" onclick="return confirm('确定删除？')">删除</a>
                </td>
            </tr>
            </c:forEach>
        </table>
