...
<body>
    ...
    <div class="content">
        ...
        <h2>编辑岗位</h2>
        <form action="<%= ctx %>/system/post/save" method="post">
            ...
            <div class="form-group">
                <label>岗位编码</label>
                <input type="text" name="postCode" value="${post.postCode}" required>
            </div>
            <div class="form-group">
                <label>排序</label>
            ...
            <a href="<%= ctx %>/system/post/list" class="btn btn-cancel">取消</a>
        </form>
    </div>
</body>
</html>