...
<body>
    ...
    <div class="content">
        ...
        <h2>岗位管理</h2>
        <a href="/system/post/add" class="btn">添加岗位</a>
        <table>
            <tr>
                <th>岗位名称</th>
                <th>岗位编码</th>
            ...
            <tr>
                ...
                <td>
                    <a href="/system/post/edit/${post.postId}" class="btn btn-edit" style="display: inline-block;">编辑</a>
                    <a href="/system/post/delete/${post.postId}" class="btn btn-danger" style="display: inline-block;" onclick="return confirm('确定删除？')">删除</a>
                </td>
            </tr>
            </c:forEach>
        </table>
